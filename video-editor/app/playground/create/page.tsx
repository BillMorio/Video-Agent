...
export default function CreativeSparkPage() {
  ...
  const handleStart = async () => {
    ...
    addLog("System: Initializing Creative Spark Engine...", "system");
    
    await new Promise(r => setTimeout(r, 800));
    addLog("Neural: Propagating ideation vectors...", "ai");
    
    await new Promise(r => setTimeout(r, 600));
    addLog("Signal: Creative buffer synchronized.", "system");
    
    await new Promise(r => setTimeout(r, 1000));
    router.push("/playground/create/script");
  };
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden font-sans relative selection:bg-primary/30">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative z-10">
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-6 py-20 relative overflow-y-auto">
          <div className="max-w-2xl w-full space-y-12 text-center mt-20">
            ...
            <div className="space-y-4">
               ...
               <p className="text-muted-foreground text-sm font-medium tracking-wide max-w-md mx-auto opacity-60">
                  Ignite your cinematic narrative with a single prompt. Our agents will handle the scripting and synthesis.
               </p>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-card/60 border border-border/50 rounded-[2.5rem] p-10 backdrop-blur-md shadow-2xl">
                  <div className="flex items-center justify-between mb-6">
                     <div className="flex items-center gap-2.5">
                        <div className="w-2 h-2 rounded-full bg-primary shadow-glow shadow-primary/40 animate-pulse" />
                        <span className="text-[10px] technical-label uppercase tracking-[0.3em] text-muted-foreground font-black italic">Input_Buffer_Ready</span>
                     </div>
                  ...
                  <div className="flex items-center gap-2 pt-8 border-t border-border/20">
